        ...
        function ($scope, $state, $http, $compile, $templateCache, $interval, utils) {
            ...
            function displayMarkers(stations) {
                ...
                for (i = 0; i < stations.length; i++) {
                    ...
                    var icon = {
                        path: (station.peak ?
                            "M10,63.7L70.1-40.5H10V-60v-90h-20v90v19.5h-60.1L-10,63.7V130l-40-30l50,90l50-90l-40,30V63.7z M-33,0c0-18.2,14.8-33,33-33S33-18.2,33,0S18.2,33,0,33S-33,18.2-33,0z" :
                            "M10,60v-0.8C38.4,54.4,60,29.7,60,0S38.4-54.4,10-59.2V-60v-90h-20v90v0.8C-38.4-54.4-60-29.7-60,0s21.6,54.4,50,59.2V60v70l-40-30l50,90l50-90l-40,30V60z M-40,0c0-22.1,17.9-40,40-40S40-22.1,40,0S22.1,40,0,40S-40,22.1-40,0z"
                        ),
                        scale: 0.12,
                        fillOpacity: 1,
                        fillColor: color,
