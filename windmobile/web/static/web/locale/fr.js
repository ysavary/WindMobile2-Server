(function () {
    fr = {
        ...
        'SOCIAL_LOGIN_SUMMARY_TITLE': "Se connecter avec votre compte Facebook ou Google",
        'SOCIAL_LOGIN_BENEFIT_1': "profiter des données en temps réel (retard de 15 minutes quand pas connecté)",
        'SOCIAL_LOGIN_BENEFIT_2': "sauvegarder vos stations préférées",
